  ...
  return (
    <main className="flex flex-col h-[100dvh] w-full overflow-hidden">
      ...
      <div className="flex justify-end w-full px-10 py-3">
        <X className="cursor-pointer text-gray-600" onClick={() => navigate('/login')}/>
      </div>
      <Swiper
        className="w-full flex-1"
        modules={[Pagination]}
        pagination={{ el: ".onboarding-pagination", type: "bullets", clickable : true }}
        spaceBetween={0}
        slidesPerView={1}
      ...
      >
        ...
        <SwiperSlide className="flex flex-col w-full">
          ...
          <div className="relative flex-1 flex justify-center items-center">
            ...
            <Onboarding2_frame_1 className="absolute top-1/2 left-1/2 -translate-x-[85%] -translate-y-[-960%] z-10" />
            <Onboarding2_frame_2 className="absolute top-1/2 left-1/2 -translate-x-[95%] -translate-y-[-1200%] z-10" />
          </div>
        </SwiperSlide>
        {/* Slide 3 */}
        <SwiperSlide className="flex flex-col w-full ">

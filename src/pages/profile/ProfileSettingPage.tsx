...
const ProfileSettingPage = () => {
    ...
    const renderContent = () => {
        switch (type) {
            case 'terms':
                return (
                    <div className="bg-gray-900 rounded-[10px] overflow-hidden p-5 min-h-125">
                        ...
                        <div className="flex flex-col text-[12px] leading-[150%] tracking-[-0.025em]">
                            ...
                            <div className="mb-3 flex flex-col gap-0.5">
                                ...
                                <p className="text-gray-300 font-normal mb-1">다음 행위는 금지됩니다.</p>
            ...
            case 'privacy-policy':
                return (
                    <div className="bg-gray-900 rounded-[10px] overflow-hidden p-5 min-h-125">
                        <h2 className="text-[20px] font-semibold text-white leading-[150%] tracking-[-0.025em] mb-2">
                            개인정보 처리 방침
                        </h2>
                        <p className="text-gray-300 text-[12px] font-medium leading-[150%] tracking-[-0.025em] mb-3">
                            최종 업데이트: 2025년 12월 30일
                        </p>
                        <div className="flex flex-col text-[12px] leading-[150%] tracking-[-0.025em]">
                            <p className="text-white font-normal mb-7">
                            ...
                            <div className="mb-3 flex flex-col gap-0.5">
                                ...
                                <p className="text-gray-300 font-normal mb-1">수집한 개인정보는 다음의 목적에만 사용됩니다.</p>
                            ...
                            <div className="flex flex-col gap-0.5">
                                ...
                                <p className="text-gray-300 font-normal mb-1">개인정보 관련 문의는 아래 이메일로 연락해 주세요.</p>
            ...
            case 'notifications':
                return (
                    <div className="flex flex-col">
                        {/* 시스템 알림 */}
                        <div className="mb-7">
                            <h2 className="text-gray-200 text-[16px] font-normal font-weight-600leading-[150%] tracking-[-0.4px] mb-3">
                                시스템 알림
                            </h2>
                        ...
                        {/* 아카이브 보드 알림 */}
                        <div className="mb-7">
                            <h2 className="text-gray-200 text-[16px] font-normal font-weight-600 leading-[150%] tracking-[-0.4px] mb-3">
                                아카이브 보드 알림
                            </h2>
                            <NotificationSettingItem
                                title="바이브 톤 알림"
    ...
    return (
        <div className="w-full h-full bg-black text-white flex flex-col px-5">
            <header className="flex items-center justify-between relative mt-[8.06px] mb-7 shrink-0 h-7.5">
                <button
                    onClick={() => navigate(-1)}
            ...
            <div className="flex-1 overflow-y-auto scrollbar-hide pb-30">
                {renderContent()}
            </div>
        </div>
    );

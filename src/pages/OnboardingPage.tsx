...
export const OnboardingPage = () => {
  ...
  return (
    <main className="flex flex-col h-[100dvh] w-full overflow-hidden">
      ...
      <div
        className={`onboarding-pagination absolute bottom-0 w-full flex justify-center gap-2 pb-[env(safe-area-inset-bottom)] z-50 ${isLast ? "opacity-0 pointer-events-none" : "opacity-100"
          }`}
      />
    </main>
  );

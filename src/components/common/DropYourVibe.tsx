...
export const DropYourVibe = () => {
  return (
    <div className="relative flex items-center justify-center gap-2 rounded-full border border-white/10 bg-black px-[18px] py-[12px] shadow-[inset_0_1px_1px_rgba(255,255,255,0.4)]">
